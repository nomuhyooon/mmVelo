...
runPath = "/home/nomura/Proj/mmvelo/experiments/Greenleaf_multiome_Cond_merged_all_missing/2024-01-19T11:22:03_barch_128"
...
plot_umap(dm, runPath, embedding=False, cluster_name="Sample.ID")
plot_umap(dm, runPath, embedding=False, cluster_name="Condtioning_ID")
plot_umap(dm, runPath, embedding=False, cluster_name="modality")
#plot_umap(dm, runPath, embedding=False, cluster_name="modality_id")
#plot_umap(dm, runPath, embedding=False, cluster_name="modality_Sample.ID")
