...
x_raw = np.concatenate([p_raw, u_raw, s_raw], axis=0) 
x_raw.shape # 11205, 1109
...
cossim_mat = np.dot(binned_dx.T, binned_dx)
norms = np.linalg.norm(binned_dx, axis=0)
