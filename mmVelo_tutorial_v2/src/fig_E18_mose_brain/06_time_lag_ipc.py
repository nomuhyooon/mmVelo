...
# to calculate differential testing, scaling expression to std 1
adata_r.X = adata_r.layers["spliced"] + adata_r.layers["unspliced"]
sc.pp.scale(adata_r, zero_center=False)
adata_r_ipc = adata_r[adata_r.obs["clusters"] == "IPC", :]
