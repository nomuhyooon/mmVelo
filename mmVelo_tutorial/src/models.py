...
sys.path.append("./src")
from Proj.mmvelo.src.tutorial.mmVelo_tutorial.src.modules import VAE_RNA, VAE_ATAC
from Proj.mmvelo.src.tutorial.mmVelo_tutorial.src.funcs import kl_divergence, convert_mean_disp_to_counts_logits, ZINB_logits
