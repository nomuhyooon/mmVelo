...
**Data**: Preprocessed 10x Multiome mouse brain data are available on Zenodo. Please download the dataset and place the files in `data/mouse_brain/`.
...
**Data**: Preprocessed multiome/scRNA-seq/scATAC-seq data and cell annotations are　available on Zenodo. Please download the dataset and place the files in `data/human_brain/`.
